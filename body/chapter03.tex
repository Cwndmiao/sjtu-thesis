...
\begin{figure}[!htbp]
  \centering
  \includegraphics[width=0.7\textwidth]{chap3/pio_read2.png}
...
\begin{figure}[!htbp]
  \centering
  \includegraphics[width=0.7\textwidth]{chap3/dma_read2.png}
...
\includegraphics[width=0.7\textwidth]{chap3/process_list_a.png}}
%\hspace{1px}
\subfigure[module-list的运行结果]{
\label{fig:libvmi:b} %% label for second subfigure
\includegraphics[width=0.7\textwidth]{chap3/module_list_a.png}}
...
\begin{figure}[!htbp]
  \centering
  \includegraphics[width=0.7\textwidth]{chap3/process_list_b.png}
...
\begin{figure}[!htbp]
  \centering
  \includegraphics[width=0.7\textwidth]{chap3/root_hijack_a.png}
...
\begin{figure}[!htbp]
  \centering
  \includegraphics[width=0.7\textwidth]{chap3/root_hijack_b.png}
...
\begin{figure}[!htbp]
  \centering
  \includegraphics[width=0.7\textwidth]{chap3/exe_flow.png}
...
\begin{figure}[!htbp]
  \centering
  \includegraphics[width=0.7\textwidth]{chap3/disk_dynamic.png}
