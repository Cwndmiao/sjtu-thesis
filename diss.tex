...
% 中文封面内容(关注内容而不是形式)
\title{虚拟化环境下操作系统性能和安全性的研究}
\author{缪\quad{}天\quad{}翔}
\advisor{陈海波教授}
\degree{硕士}
\defenddate{2014年12月31日}
\school{上海交通大学}
\institute{软件学院}
...
% 英文封面内容(关注内容而不是表现形式)
\englishtitle{Research on Operating System Performance and Security in Virtualized Environments}
