...
% 中文封面内容(关注内容而不是形式)
\title{虚拟化环境下操作系统安全性和性能的研究}
\author{缪\quad{}天\quad{}翔}
\advisor{陈海波教授}
\degree{硕士}
\defenddate{2015年 1月12日}
\school{上海交通大学}
\institute{软件学院}
\studentnumber{1120379061}
\major{软件工程}

% 英文封面内容(关注内容而不是表现形式)
\englishtitle{Research on Operating System Security and Performance in Virtualized Environments}
\englishauthor{\textsc{Tianxiang Miao}}
\englishadvisor{Prof. \textsc{Haibo Chen}}
...
% 使用 BibTeX
% 包含参考文献文件.bib
\bibliography{reference/chap1,reference/chap2,reference/chap3,reference/chap4,reference/conclusion}
